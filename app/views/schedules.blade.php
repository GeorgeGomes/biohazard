...
?>  id="user">{{ trans('customize.User');}} Name</option>
                        <option value="provider" <?php
if (isset($_GET['type']) && $_GET['type'] == 'provider') {
    echo 'selected="selected"';
}
?>  id="provider">{{ trans('customize.Provider');}}</option>
            ...
            <div class="box-body row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <select class="form-control" id="searchdrop" name="type">
                        ...
                        <option value="user" id="user">{{ trans('customize.User');}} Name</option>
        ...
        <tbody>
            ...
            <?php foreach ($schedules as $schedule) { ?>
                <tr>
                    ...
                    <td><?php echo $schedule->user_first_name . " " . $schedule->user_last_name; ?> </td>
