...
@section('content')
      ...
      <div class="row marketing">
        ...
        //-----------------------------------------------------------SENDGRID SECRET
        <div class="form-group sendgrid1" style="display:none">
          <label for="exampleInputPassword1">Sendgrid Secret</label>
          <input type="text" class="form-control"  name="sendgrid_secret" placeholder="Sendgrid Secret" value="{{ Session::get('sendgrid_secret'); }}">
        </div>	
        ...
        //-----------------------------------------------------------SENDGRID USERNAME
        <div class="form-group sendgrid" style="display:none">
          <label for="exampleInputPassword1">Sendgrid Username</label>
          <input type="text" class="form-control"  name="sendgrid_username" placeholder="Sendgrid Username" value="{{ Session::get('sendgrid_username'); }}">
        </div>
