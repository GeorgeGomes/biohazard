    ...
    <div class="landing">
        ...
        <div class="row landing-page-text">
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <h1>NÓS ESTAMOS <span>LANÇANDO</span> EM BREVE</h1>
            </div>
        </div>
        <div class="row input-register">
            ...
            <div class="col-md-4 uber-input"><input type="text" id="register" name="register" placeholder="Entre seu endereço de e-mail" ></div>
            <!-- <div class="col-md-2 register-button" data-toggle="modal" data-target="#myModal1"><a href="#">Register</a></div> -->
            <div class="col-md-2 register-button" data-toggle="modal" data-target="#myModal1"><a href="#">Registrar</a></div>
        </div>
    ...
    <div class="row contact-form">
        <div class="container">
            <div class="col-md-8 col-md-offset-2">
                ...
                <button type="submit" class="btn-blue form-control">{{ trans('login.submit');}}</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3>Diga Oi, Entre em Contato</h3>
            </div>
        </div>
        <div class="row social-icons">
            <ul class="col-md-12 icons text-center">
        ...
        <div class="row">
            ...
            <p> Copyright ProvenLogic. Todos os Direitos Reservados.</p>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="{{ trans('login.password');}}" required><br/><br/>
                    <!-- <button type="submit" class="btn-blue form-control">login</button><br/><br/> -->
                    <button type="submit" class="btn-blue form-control">Logar</button><br/><br/>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="{{ trans('login.password');}}" required="true"><br>
                    ...
                    <button type="submit" class="btn-blue form-control">Registrar</button><br/><br/>
                </form>
            </div>
        </div>
    </div>
            ...
            steps: [
                {
                    ...
                    intro: "Bem-vindo ao UberForX, isso vai ajuda-lo a conhecer o aplicativo. Por favor siga os passos a seguir"
                },
                {
                    element: '.register-button',
                    // intro: "Enter your email-id to register or login with next step",
                    intro: "Entre a ID do seu e-mail para registrar ou logar como próximo passo",
                    position: 'top'
                ...
                },
                {
                    ...
                    intro: 'Clique aqui para logar se você já for registrado',
                    position: 'left'
                }
            ]
        });
            ...
            steps: [
                {
                    ...
                    intro: 'Você foi registrado com sucesso. Por favor vá ao <a href="../admin/index.php/login" target="_blank">admin panel</a> e aprove o registro.'
                },
                {
                    element: '.login-button',
                    // intro: 'Click here to login',
                    intro: 'Clique aqui para logar',
                    position: 'left'
                }
            ]
        });
