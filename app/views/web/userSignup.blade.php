...
$(document).ready(function () {
    ...
    response_text = '{{trans('login.timezone_not_found');}}';
            ...
            <div class="container">
                ...
                <form class="form-login" action="{{route('/user/save')}}" method="post">
                    ...
                    <div class="login-wrap">
                        <input type="text" name="first_name" required class="form-control" maxlength="30" placeholder="{{trans('provider.first_name');}}" autofocus><br>
                        <input type="text" name="last_name" required class="form-control" maxlength="30" placeholder="{{trans('provider.last_name');}}" ><br>
...
<!--<input type="text" name="email" required class="form-control" placeholder="{{ trans('login.mail');}}" >-->
                        <span id="no_email_error1" style="display: none"> </span>
                        <input type="text" name="email" class="form-control" maxlength="60" placeholder="{{trans('provider.mail_grid');}}" onblur="ValidateEmail(1)" id="email_check1" required="" >

                        <br>
                        <input type="password" name="password" required class="form-control" maxlength="20" placeholder="{{ trans('login.password');}}"><br>
                        ...
                        <br>-->
                        <input type="text" name="referral_code" class="form-control" maxlength="15" placeholder="{{trans('user.referrals_code');}}" >
                        <br>
                        ...
                        <button id="register" class="btn btn-theme btn-block" type="submit"><i class="fa fa-lock"></i> {{ trans('login.register');}}</button>
                        ...
                        <div class="registration">
                            ...
                            <a class="" href="{{route('/user/signin')}}">
                                {{ trans('login.login');}}
                            </a>
                        </div>
        ...
        <script type="text/javascript">
                            ...
                            tour.addSteps([
                                {
                                    element: "#user-signup",
                                    title: "{{trans("login.enter_new_user");}}",
                                    content: "{{trans("login.enter_new_user_message");}}",
                                },
                            ]);
