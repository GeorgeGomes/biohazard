...
<div class="col-md-12 mt">
    ...
    <div class="alert alert-danger">
        <b>{{trans("user_provider_web.profile_photo");}}</b> 
    </div>
    @endif
    ...
    <div class="content-panel">
        <h4>{{trans("user_provider_web.update_perfil");}}</h4><br>
        <form class="form-horizontal style-form" method="post" action="{{route('/user/update_profile')}}" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('provider.first_name');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="first_name" maxlength="30" value="{{ $user->first_name }}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('provider.last_name');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="last_name" maxlength="30" value="{{ $user->last_name }}">
                </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{ trans('provider.picture_grid');}}</label>
                <div class="col-sm-1">
                    <img src="<?php
                    if ($user->picture == "") {
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{ trans('provider.bio_grid');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="bio" maxlength="230" value="{{ $user->bio }}">
                </div>
            </div>
            <!-- <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('provider.address');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="address"  value="{{ $user->address }}">
                </div>
            </div> -->
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('provider.state');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="state" maxlength="20" value="{{ $user->state }}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('provider.country');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="country" maxlength="20" value="{{ $user->country }}">
                </div>
            </div>
            <!-- <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('provider.zipcode');}}</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="zipcode"  id="cep" maxlength="10" value="{{ $user->zipcode }}">
                </div>
            </div> -->
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans("user_provider_web.timezone");}}</label>
                <div class="col-sm-6">
    ...
    <div class="content-panel">
        ...
        <form class="form-horizontal style-form" method="post" action="{{route('/user/update_password')}}">
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('login.old_password');}}</label>
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="current_password" maxlength="20" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('login.new_password');}}</label>
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="new_password" maxlength="20" value="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">{{trans('login.confirm_password');}}</label>
                <div class="col-sm-6">
                    <input type="password" class="form-control" name="confirm_password" maxlength="20" value="">
                </div>
            </div>
            <span class="col-sm-2"></span>
...
<script type="text/javascript">
     ...
     $('#cep').keydown(function (e) {
            ...
            $cep = $(this);
                ...
                // Auto-format- do not expose the mask as the user begins to type - 00.000-000
            if (key !== 8 && key !== 9) {
                if ($cep.val().length === 2) {
                    $cep.val($cep.val() + '.');
                }
