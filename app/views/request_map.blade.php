    ...
    <table class="table table-bordered">
        <tbody>
            <tr>
                ...
                <th>{{ trans('map.provider_name');}}</th>
                <th>{{ trans('map.user_name');}}</th>
...
controlDiv.style.padding = '5px';
        ...
        // Add the text
        controlText.innerHTML = '<b>{{trans('map.legend')}}</b><br />' +
        ...
        '<small>*{{trans('map.data_fake')}}</small>';
