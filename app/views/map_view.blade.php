...
<div class="box box-success">
    ...
    <div class="col-md-8">
        <input type="text" class="form-control" id="my-address" placeholder="{{trans('map.type_address');}}">
    </div>

    <div class="col-md-4" id="flow2">
        <button id="getCords" class="btn btn-success" onClick="codeAddress();">{{trans('map.find_location');}}</button>
    </div>
    </br>
    <!--<div class="page_load">
...
<?php } ?>
                            ...
                            var infowindow = new google.maps.InfoWindow({
                                map: map,
                                position: pos,
                                content: "{{trans('map.you_are_here');}}"
                            });
                                ...
                                function (data) {
                                    ...
                                    for (var i = 0; i < markers.length; i++) {
                                        ...
                                        if (type == 'driver_on_trip') {
                                            ...
                                            html = "<b>" + client_name + "</b><p style='font-size:16px;'><b><span class ='fa fa-mobile-phone icon-phone' style=''></span><span style='margin-left:5px;'>" + contact + "</span></b><br/>Status : {{trans('map.ontrip');}}</p>";
                                        } else if (type == 'driver_free') {
                                            color = "green";
                                            /*html = "<b>" + client_name + "</b></p><p><span class ='icon-phone' style=''></span><span style='margin-left:5px;'><br>" + contact + "</span></p><b>";*/
                                            html = "<b>" + client_name + "</b><p style='font-size:16px;'><b><span class ='fa fa-mobile-phone icon-phone' style=''></span><span style='margin-left:5px;'>" + contact + "</span></b><br/>Status : {{trans('map.free');}}</p>";
                                        } else {
                                            color = "red";
                                            html = "<b>" + client_name + "</b><p style='font-size:16px;'><b><span class ='fa fa-mobile-phone icon-phone' style=''></span><span style='margin-left:5px;'>" + contact + "</span></b><br/>Status : {{trans('map.inactive');}}</p>";
                                            /*html = "<b>" + client_name + "</b></p><p><span class ='icon-phone' style=''></span><span style='margin-left:5px;'><br>" + contact + "</span></p><b>";*/
                                        }
            ...
            function Legend(controlDiv, map) {
                ...
                // Add the text
                controlText.innerHTML = '<b>Legendas</b><br />' +
                        '<img src="<?php echo asset_url(); ?>/image/driver_available.png" style="height:25px;"/> {{trans('map.available');}}<br />' +
                        '<img src="<?php echo asset_url(); ?>/image/driver_on_trip.png" style="height:25px;"/> {{trans('map.ontrip');}}<br />' +
                        '<img src="<?php echo asset_url(); ?>/image/driver_not_approved.png" style="height:25px;"/> {{trans('map.inactive');}}<br />'
