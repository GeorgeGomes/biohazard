...
function initialize(cur_lat, cur_lon, prev_lat, prev_lon) {
    ...
    function handleNoGeolocation(errorFlag) {
        if (errorFlag) {
            var content = '{{ trans('website.geo_fail');}}';
        } else {
            var content = '{{ trans('website.geo_fail_browser');}}';
        }
    }
}
        </script>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo web_url(); ?>/user/signin">{{ trans('website.login');}}</a></li>
                        <li><a href="<?php echo web_url(); ?>/user/signup">{{ trans('website.signup');}}</a></li>
                    </ul>
                </div>
            </div>
    ...
    setInterval(function () {
        ...
        $.ajax(url, {
            ...
            success: function (response) {
                ...
                {
                    console.log("'{{ trans("website.went_wrong");}}'");
                }
