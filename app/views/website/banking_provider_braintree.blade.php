  ...
  <div class="box box-primary">
    <div class="box-header">
      ...
      <form method="post" action="{{ URL::Route('ProviderBBanking') }}" id="addressformadmin"  enctype="multipart/form-data">
        ...
        <input type="text" name="email" class="form-control" placeholder="{{ trans('login.mail');}" value="{{$provider -> email }}" required><br>
        <input type="text" name="phone" class="form-control" placeholder="{{ trans('provider.phone_grid');}" value="{{$provider -> phone }}" required><br>
        <input type='text' name="dob" class="form-control" placeholder="{{ trans('website.birth');}" id='datetimepicker6' required><br>
        ...
        <input type="text" name="streetAddress" class="form-control" placeholder="{{trans('provider.address');}}" required><br>
        <input type="text" name="locality" class="form-control" placeholder="{{trans('website.city');}}" required><br>
        <input type="text" name="region" class="form-control" placeholder="{{trans('provider.state');}}" required><br>
        <input type="text" name="postalCode" class="form-control" placeholder="{{trans('provider.zipcode');}}" required><br>
        <label>{{ trans('website.funding');}}</label>
        <input type="text" name="bankemail" class="form-control" value="{{$provider -> email }}" required><br>
        <input type="text" name="bankphone" class="form-control" value="{{$provider -> phone }}" required><br>
        ...
        <br><input type="submit" value="{{ trans('website.update_change');}}" class="btn btn-block btn-flat btn-green">
        </div>
      </form>
</div>
