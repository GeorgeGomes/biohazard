...
<p align="right"><a href="{{ URL::Route('AdminSettingInstallation') }}"><button class="btn btn-info btn-flat">{{trans('setting.conf_install')}}</button></a></p>
<?php } ?>
...
<div class="row">
	...
	<div class="col-md-6 col-sm-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title">{{trans('setting.conf_base_app')}}</h3>
			</div><!-- /.box-header -->
			<!-- form start -->
								...
								if ($setting->key != 'default_charging_method_for_users') {
									...
									<div class="form-group">
										...
										<select class="form-control" name="<?php echo $setting->id; ?>">
											...
											?> >
														<?php if ($setting->key == 'default_charging_method_for_users') { ?>
													{{trans('setting.fixed_price')}}
												<?php } elseif ($setting->key == 'default_distance_unit') { ?>
													{{trans('setting.km')}}
												<?php } elseif ($setting->key == 'request_time_costing_type') { ?>
													{{trans('setting.total_time_request')}}
												<?php } else { ?>
													{{trans('setting.no')}}
												<?php } ?>
											</option>
	...
	<div class="col-md-6 col-sm-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title">{{trans('setting.advanced_settings')}}</h3>
			</div><!-- /.box-header -->
			<div class="box-body">
				<?php
				foreach ($settings as $setting) {
	...
	<div class="col-md-6 col-sm-12">
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title">{{trans('setting.theme_settings')}}</h3>
			</div><!-- /.box-header -->
			<!-- form start -->
			<form enctype="multipart/form-data" onsubmit="Checkfiles(this)" method="post" action="{{ URL::Route('AdminTheme') }}">
				<div class="box-body">
					...
					<div class="form-group">
						<label>{{trans('setting.logo')}}</label>
						<input type="file" class="form-control" name="logo" id="logo"></input>
						<p class="help-block">{{trans('setting.image_png')}}</p>
					...
					<hr>
					<div class="form-group">
						<label>{{trans('setting.icon')}}</label>
						<input type="file" class="form-control" name="icon" id="icon"></input>
						<p class="help-block">{{trans('setting.image_ico')}}</p>
						<?php if (isset($theme->id)) { ?>
					...
					<?php if ($setting->key == 'layout_color') { ?>
						<div class="form-group">
							<label>{{trans('setting.layout_color')}}</label>
							<!-- <p class="help-block">{{trans('setting.layout_color')}}</p> -->
							<?php if (isset($theme->id)) { ?>
				...
				<div class="box-footer">
					<button type="submit" id="theme" class="btn btn-primary btn-flat btn-block">{{trans('keywords.save_change');}}</button>
				</div>
			</form>
		</div>
	</div>
