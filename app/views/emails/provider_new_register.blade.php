            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ URL::Route('IndexPrestador') }}" style="color:#545454; outline:none; text-decoration:none;">{{trans('email.Welcome_to')}} <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')) ?>, {{ $vars['name'] }}</a> </span>
                    </td>
                </tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    <div style="padding: 10px;font-size:22px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color: #68dff0;text-align:center;">{{trans('email.thanks_singin')}}
                                    </div>
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">{{trans('email.just_upload_doc')}}
                                    </div>
                                    <br><br>
                                    <div style="text-align:center"><a href="{{ URL::Route('ProviderSignin') }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ffffff;color:#545454;text-align:center;  text-decoration: none;">{{trans('email.Go_to_Site')}} </a></div>
                                    <br>
                                </td>
                            </tr>
                            <tr>
