            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}/provider/signin" style="color:#545454; outline:none; text-decoration:none;">{{trans('email.Password_Reset')}}</a></span>
                    </td>
                </tr>
                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        <strong style="font-weight: bold;">{{trans('email.Congratulation')}}...!!!</strong>
                                    </div>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        {{trans('email.password_sucess')}}
                                        <strong style="font-weight: bold;">{{ $vars['new_password'] }}</strong>. 
                                        <br>
                                        {{trans('email.change_password')}}
                                    </div>
                                    <br>
                                    <div style="text-align:center"><a href="{{ $vars['login_url'] }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ffffff;color:#545454;text-align:center;  text-decoration: none;">{{trans('email.Login')}}</a></div>
                                    <br>
                                </td>
                            </tr>
                            <tr>
