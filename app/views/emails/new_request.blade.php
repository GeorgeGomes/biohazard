...
<html>
    <head>
        ...
        <title>{{trans('email.New_Request_Created')}}</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}/provider/signin" style="color:#545454; outline:none; text-decoration:none;">{{trans('email.Ride_Booking_Request')}}</a></span>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        {{trans('email.ride_request_id')}}
                                        <strong style="font-weight: bold;">{{ $vars['trip_id'] }}</strong>. 
                                        {{trans('email.follow_request')}}
                                        <a href="{{ $vars['follow_url'] }}" style="color:#545454; outline:none; text-decoration:none;"><strong style="font-weight: bold;"> {{trans('email.URL')}} </strong></a>. 
                                        <?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?>
                                    </div>
                                    <br>
                                    <div style="text-align:center"><a href="{{ web_url() }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ffffff;color:#545454;text-align:center;  text-decoration: none;">{{trans('email.Follow')}}</a></div>
