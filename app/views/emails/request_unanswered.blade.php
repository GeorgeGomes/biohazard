...
<html>
    <head>
        ...
        <title>{{trans('email.Request_Was_Unanswered')}}</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}/provider/signin" style="color:#545454; outline:none; text-decoration:none;">{{trans('email.OOPPSS')}}!!!</a></span>
                    </td>
                </tr>
