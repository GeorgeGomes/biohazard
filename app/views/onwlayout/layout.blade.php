                ...
                <div class="page-sidebar navbar-collapse collapse" >
                    ...
                    <ul class="page-sidebar-menu page-sidebar-menu-light" data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li id="dashboard" >
                            ...
                            <a href="{{ URL::Route('UserAdminReport') }}">
                                <i class="icon-home"></i>
                                <span class="title">Dashboard</span>
                            </a>
                        </li>
                        ...
                        <li id="bank"><span class="arrow "></span>
                          ...
                          <li id="UserProfile"><span class="arrow "></span>
                ...
                <!--                <div class="page-sidebar navbar-collapse collapse" >
                                    ...
                                    <ul class="sidebar-menu">
                                        ...
                                        <li id="dashboard" title="Dashboard">
                                            <a href="{{ URL::Route('UserAdminReport') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                                        </li>
