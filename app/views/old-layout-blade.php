...
<nav class="primary navbar navbar-default" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li id="providers" title="Providers" >
            ...
            <li id="users" title="Users">
                <a href="{{ URL::Route('AdminUsers') }}"><img src="<?php echo asset_url() ?>/image/menu_buttons/user_icon.png"/><br>Users</a>
            </li>
    ...
    <div class="container">
        <ul class="nav nav-pills">
            ...
            <li id="users" title="Users">
                ...
                <a href="<?php echo web_url(); ?>/admin/users"><img src="<?php echo asset_url() ?>/image/menu_buttons/user_icon.png"/>Users</a>
