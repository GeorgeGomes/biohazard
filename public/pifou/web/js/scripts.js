...
$(document).ready(function () {
	$('.slider').owlCarousel({
		...
		margin: 10,
		nav: true,
		navText: ['<i class="icon icon-arrow-left font40"></i>', '<i class="icon icon-arrow-right font40"></i>'],
		responsive: {
			0: {
				items: 1
			},
...
(function ($) {
	...
	$('#contactform').submit(function () {
		...
		$("#message").slideUp(750, function () {
			$('#message').hide();
			//$('#submit')
			//	.after('<img src="website/img/assets/contact-form-loader.gif" class="loader" />')
	...
	$("#map").gmap3({
		marker: {
			address: "Rua dos Goitacazes, 375, Centro - Belo Horizonte - MG",
			options: {
				icon: "website/website/img/assets/marker.png"
			}
		},
		map: {
			options: {
	...
	$(".home-fullscreen-slider").backstretch([
        "website/img/slide-1.jpg",
        "website/img/slide-2.jpg",
        "website/img/slide-3.jpg"
    ], {
		fade: 750,
		duration: 4000
	});
