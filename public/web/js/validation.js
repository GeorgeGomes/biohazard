...
function ValidateEmail(i)
{
    ...
    if (mailvalue.value.match(mailformat))
    {
        ...
        var eml_err = document.getElementById("no_email_error" + i);
        eml_err.style.color = error_color;
        eml_err.innerHTML = "Não é um e-mail válido.<br/>";
...
function notzero(i)
{
    ...
    if (mailvalue.value > 0 || mailvalue.value == "")
    {
        ...
        var eml_err = document.getElementById("no_zero_error" + i);
        eml_err.style.color = error_color;
        eml_err.innerHTML = "Você não pode colocar esse campo como 0 (Zero).<br/>";
...
function Ismobile(e, i) {
    ...
    err_div.innerHTML = "Não é um número de telefone válido.<br/>";
...
function IsNumeric(e, i) {
    ...
    err_div.innerHTML = "Não é um número válido.<br/>";
...
function Isamount(e, i) {
    ...
    err_div.innerHTML = "Não é um valor válido.<br/>";
