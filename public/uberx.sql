...
CREATE TABLE IF NOT EXISTS `ledger` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `ledger_user_id_foreign` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
('2014_09_25_044324_create_users_table', 1),
('2014_09_25_060804_create_dogs_table', 1),
('2014_09_30_014129_create_provider_table', 1),
('2014_10_07_113949_create_review_user_table', 1),
('2014_10_07_114245_create_review_provider_table', 1),
('2014_10_07_114415_create_request_location_table', 1),
...
('2014_10_13_024755_add_picture_to_provider_table', 1),
('2014_10_14_052816_add_provider_id_to_schedules_table', 1),
('2014_10_14_142220_add_fields_to_user', 1),
('2014_10_14_142558_add_fields_to_provider', 1),
('2014_10_15_114904_add_lat_long_to_provider_table', 1),
...
('2014_10_18_051813_add_user_id_to_payment', 1),
...
('2014_10_21_021438_replace_walk_id_to_reques_id_review_provider_table', 1),
('2014_10_21_021816_add_is_rated_in_walk', 1),
('2014_10_21_023844_replace_walk_id_to_reques_id_request_location_table', 1),
...
('2014_10_27_112629_change_lat_long_data_type_request_location', 1),
('2014_10_27_112915_add_lat_long_data_type_provider', 1),
('2014_10_27_112953_add_lat_long_data_type', 1),
('2014_11_01_015046_create_admin_table', 1),
('2014_11_01_015258_add_is_approved_to_provider', 1),
('2014_11_09_154756_add_information_table', 1),
('2014_11_09_181432_add_referal_data_to_user', 1),
('2014_11_09_181525_add_ledger_table', 1),
('2014_11_10_035803_add_provider_type_table', 1),
('2014_11_10_040329_add_type_to_provider', 1),
...
('2014_11_18_111038_add_distance_request_location', 1),
...
('2014_12_03_172949_add_foreign_key_review_user', 1),
('2014_12_03_173126_add_foreign_key_review_user_2', 1),
('2014_12_03_173221_add_foreign_key_review_user_3', 1),
('2014_12_03_174014_add_foreign_key_review_provider', 1),
('2014_12_03_174427_add_foreign_key_request_location', 1),
...
('2014_12_17_132347_update_provider_table', 1),
('2014_12_26_111728_create_provider_services_table', 1),
('2014_12_26_115353_create_request_services_table', 1),
('2014_12_26_115511_remove_fields_from_provider_type_table', 1),
('2014_12_27_023550_add_fields_to_provider_services_table', 1),
...
('2015_01_02_125640_add_card_id_to_provider', 1),
...
('2015_02_09_192206_add__debt_to_user', 1),
...
('2015_02_19_124305_index_provider_table', 1),
('2015_02_19_124904_index_request_table', 1),
('2015_02_19_134856_index_requestServices_table', 1),
('2015_02_19_135324_index_providerServices_table', 1),
...
('2015_03_12_060741_add_new_field_in_provider', 1),
...
('2015_03_20_065250_add_provider_table_default_value', 1),
('2015_03_20_065758_alter_provider_table_banking_details', 1),
...
('2015_03_31_194143_add_delete_to_provider_table', 1),
('2015_03_31_195348_add_soft_delete_to_user_table', 1),
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `is_provider_started` int(11) NOT NULL,
  `is_provider_arrived` int(11) NOT NULL,
  `is_started` int(11) NOT NULL,
  `is_completed` int(11) NOT NULL,
  `is_dog_rated` int(11) NOT NULL,
  `is_provider_rated` int(11) NOT NULL,
  ...
  KEY `request_is_provider_started_index` (`is_provider_started`),
  KEY `request_is_provider_arrived_index` (`is_provider_arrived`),
...
CREATE TABLE IF NOT EXISTS `request_meta` (
  ...
  KEY `request_meta_provider_id_foreign` (`provider_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `review_user` (
  ...
  `user_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `review_user_user_id_foreign` (`user_id`),
  KEY `review_user_provider_id_foreign` (`provider_id`),
  KEY `review_user_request_id_foreign` (`request_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `review_provider`
--

CREATE TABLE IF NOT EXISTS `review_provider` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `provider_id` int(10) unsigned NOT NULL,
  `rating` int(11) NOT NULL,
  `comment` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `user_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `review_provider_user_id_foreign` (`user_id`),
  KEY `review_provider_provider_id_foreign` (`provider_id`),
  KEY `review_provider_request_id_foreign` (`request_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
(12, 'admin_email_address', '2015-05-12 01:39:32', '2015-05-12 01:39:32', 'contato@pifouapp.com.br', 'This address will get Email notifications about requests', 1),
...
(21, 'email_provider_new_registration', '2015-05-12 01:39:32', '2015-05-12 01:39:32', 'Welcome on Board %name% , After Logged in to your account Upload your documents to get approve from the admin side , Please Activation your Email here %link% . Upload your documents and someone will look into your application and get back.', 'This Template will be used for welcome mail to provider', 3),
(22, 'email_user_new_registration', '2015-05-12 01:39:32', '2015-05-12 01:39:32', 'Welcome on Board %name%', 'This Template will be used for welcome mail to user', 3),
...
CREATE TABLE IF NOT EXISTS `provider` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `provider_email_index` (`email`),
  KEY `provider_first_name_index` (`first_name`),
  KEY `provider_last_name_index` (`last_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `provider_services` (
  ...
  `base_price` float(8,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `provider_services_provider_id_index` (`provider_id`),
  KEY `provider_services_type_index` (`type`),
  KEY `provider_services_price_per_unit_distance_index` (`price_per_unit_distance`),
  KEY `provider_services_price_per_unit_time_index` (`price_per_unit_time`),
  KEY `provider_services_base_price_index` (`base_price`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
INSERT INTO `provider_type` (`id`, `name`, `is_default`, `created_at`, `updated_at`, `icon`) VALUES
...
CREATE TABLE IF NOT EXISTS `request_location` (
  ...
  PRIMARY KEY (`id`),
  KEY `request_location_request_id_foreign` (`request_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `dog`
  ADD CONSTRAINT `dog_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `ledger`
--
ALTER TABLE `ledger`
  ADD CONSTRAINT `ledger_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
ALTER TABLE `request_meta`
  ADD CONSTRAINT `request_meta_provider_id_foreign` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`),
...
ALTER TABLE `review_user`
  ADD CONSTRAINT `review_user_request_id_foreign` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`),
  ADD CONSTRAINT `review_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `review_user_provider_id_foreign` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`);

--
-- Constraints for table `review_provider`
--
ALTER TABLE `review_provider`
  ADD CONSTRAINT `review_provider_request_id_foreign` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`),
  ADD CONSTRAINT `review_provider_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `review_provider_provider_id_foreign` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`);

--
-- Constraints for table `request_location`
--
ALTER TABLE `request_location`
  ADD CONSTRAINT `request_location_request_id_foreign` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`);
