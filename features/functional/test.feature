Feature: Welcoming developer
	...
	Scenario: Sort Acsending Request Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		And I am on "admin/requests"
		When I select "user" from "sortdrop"
		When I select "asc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Requests | Sorted by User Name in asc"
	...
	Scenario: Sort Acsending Request Page by Provider Name
		...
		And I press "submit1"
		And I am on "admin/requests"
		When I select "provider" from "sortdrop"
		When I select "asc" from "sortdroporder"
		And I press "btnsort"
	...
	Scenario: Sort Decsending Requests Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "desc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Requests | Sorted by User Name in desc"
	...
	Scenario: Search Requests Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		And I am on "admin/requests"
		When I select "user" from "searchdrop"
		When I fill in "insearch" with "Shan Wilson"
		And I press "btnsearch"
		Then I should see "Requests | Search Result"		
	...
	Scenario: Search Requests Page by Provider Name
		...
		And I press "submit1"
		And I am on "admin/requests"
		When I select "provider" from "searchdrop"
	...
	Scenario: User Edit Details Page
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
	...
	Scenario: Coupon Statistics Page
		...
		Then I should see "User | Coupon Statistics"
	
	Scenario: Sort Acsending Users Page by User ID
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "asc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Users | Sorted by User ID in asc"

	Scenario: Sort Acsending User Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "asc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Users | Sorted by User Name in asc"

	Scenario: Sort Acsending users Page by user Email
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "asc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Users | Sorted by User Email in asc"

Scenario: Sort Decsending Users Page by User ID
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "desc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Users | Sorted by User ID in desc"

	Scenario: Sort Decsending User Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "desc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Users | Sorted by User Name in desc"

	Scenario: Sort Decsending users Page by user Email
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I select "desc" from "sortdroporder"
		And I press "btnsort"
		Then I should see "Users | Sorted by User Email in desc"

	Scenario: Search User Page by User ID
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
		...
		When I fill in "insearch" with "1"
		And I press "btnsearch"
		Then I should see "Users | Search Result"		

	Scenario: Search users Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
	...
	Scenario: Search Users Page by User Email
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
	...
	Scenario: Search Users Page by User Address
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
 	...
 	Scenario: Search Reviews Page by User Name
		Given I am on "admin/login"
		When I fill in "username" with "lazar@provenlogic.net"
		When I fill in "password" with "12345"
		And I press "submit1"
