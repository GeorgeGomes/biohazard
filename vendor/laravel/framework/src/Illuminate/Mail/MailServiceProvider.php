...
class MailServiceProvider extends ServiceProvider {
	...
	protected function registerSwiftTransport($config)
	{
		switch ($config['driver'])
		{
			...
			case 'sendgrid':
				return $this->registerSendgridTransport($config);
	...
	/**
	 * Register the Sendgrid Swift Transport instance.
	 *
	 * @param  array  $config
	 * @return void
	 */
	protected function registerSendgridTransport($config)
	{
		$sendgrid = $this->app['config']->get('services.sendgrid', array());

		$this->app->bindShared('swift.transport', function() use ($sendgrid)
		{
			return new SendgridTransport($sendgrid['secret'], $sendgrid['username']);
		});
	}
