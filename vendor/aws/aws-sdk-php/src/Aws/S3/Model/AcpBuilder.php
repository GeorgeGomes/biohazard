...
{
    /**
     * @var Grantee The user for the ACL
     */
    protected $user;
    ...
    /**
     * Sets the user to be set on the ACL
     *
     ...
     * @return $this
     */
    public function setUser($id, $displayName = null)
    {
        $this->user = new Grantee($id, $displayName ?: $id, GranteeType::USER);
    ...
    {
        return new Acp($this->user, $this->grants);
    }
}
