...
class Filesystem
{
    ...
    /**
     * Change the user of an array of files or directories.
     *
     * @param string|array|\Traversable $files     A filename, an array of files, or a \Traversable instance to change user
     * @param string                    $user      The new user user name
     * @param bool                      $recursive Whether change the user recursively or not
     *
     * @throws IOException When the change fail
     */
