...
//      }
   ...
   */
  function setEncryption($userPass = '', $userPass = '', $pc = array()) {
    $p = bindec("11000000");
    ...
    if ($this->arc4_objnum == 0) {
      ...
      $this->numObj++;
      if (mb_strlen($userPass) == 0) {
        $userPass = $userPass;
      }

      $this->o_encryption($this->numObj, 'new', array('user' => $userPass, 'user' => $userPass, 'p' => $p));
    }
  }
